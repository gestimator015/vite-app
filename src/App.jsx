        ...
        <div style={{ minWidth: 600 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "56px repeat(7, 1fr)", marginBottom: 0, borderBottom: "1px solid rgba(255,255,255,.08)" }}>
            ...
            {days.map((d, i) => {
              ...
              return (
                <div key={i} style={{ textAlign: "center", paddingBottom: 8, paddingTop: 4, borderRight: i < 6 ? "1px solid rgba(0,0,0,.08)" : "none" }}>
            ...
            {Array.from({ length: hoursShown }, (_, idx) => {
              ...
              return (
                <div key={hour} style={{ display: "grid", gridTemplateColumns: "56px repeat(7, 1fr)", height: ROW_H }}>
                  ...
                  {days.map((_, ci) => (
                    <div key={ci} style={{ borderBottom: "1px solid rgba(0,0,0,.08)", borderRight: ci < 6 ? "1px solid rgba(0,0,0,.08)" : "none" }} />
                  ))}
                </div>
              );
            })}
